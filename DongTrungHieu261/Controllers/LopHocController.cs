...
namespace DongTrungHieu261.Controllers
{
    public class LopHocController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.LopHoc != null ? 
                          ...
                          Problem("Entity set 'LTQLDB.LopHoc'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("MaLop,TenLop,SoSinhVien")] LopHoc lopHoc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaLop,TenLop,SoSinhVien")] LopHoc lopHoc)
        {
            if (id != lopHoc.MaLop)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'LTQLDB.LopHoc'  is null.");
            }
            var lopHoc = await _context.LopHoc.FindAsync(id);
            if (lopHoc != null)
            {
